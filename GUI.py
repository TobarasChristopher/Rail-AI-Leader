...
startButton = tk.Button(buttonFrame, text ="Start", width=15, height=7, bg="#3bbd24", fg="black")
...
debugButton = tk.Button(buttonFrame, text ="Debug", width=15, height=7, bg="#ed951a", fg="black")
debugButton.grid(row=0,column=5, padx=5)

manualButton = tk.Button(buttonFrame, text ="Manual", width=15, height=7, bg="#8137a1", fg="black")
